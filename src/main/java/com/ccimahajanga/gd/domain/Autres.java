...
public class Autres {
	...
	public Autres(Integer autresId, Integer codeOuvrages, String titreOuvrages, String domaines, Integer nombreExemplaire, Integer etage, Integer ranger, String commentaire) {
		super();
		this.autresId = autresId;
	...
	public Integer getAutresId() {
		return autresId;
	}
	public void setAutresId(Integer autresId) {
		this.autresId = autresId;
	}
	...
	public String toString() {
		return "Autres [autresId=" + autresId + ", codeOuvrages=" + codeOuvrages
