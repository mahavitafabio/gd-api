...
public class Revue {
	...
	public Revue(Integer revuId, Integer codeOuvrages, String titreOuvrages, String domaines, Integer nombreExemplaire, Integer etage, Integer ranger, String commentaire) {
		super();
		this.revuId = revuId;
	...
	public Integer getRevuId() {
		return revuId;
	}
	public void setRevuId(Integer revuId) {
		this.revuId = revuId;
	}
	...
	public String toString() {
		return "Revue [revuId=" + revuId + ", codeOuvrages=" + codeOuvrages
