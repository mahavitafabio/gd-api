...
public class Co2018 {
	@Id
	 ...
	 public Co2018(Integer co2018Id, Integer numero, String date, String nomEntreprise, String adresse, String destination, String produit, Integer quantiteExporte, String unite, Integer nombreConteneur, String prixUnitaire, Integer montant) {
		 super();
		 this.co2018Id = co2018Id;
		 this.numero = numero;
		 this.date = date;
	...
	public Integer getCo2018Id() {
		return co2018Id;
	}
	public void setCo2018Id(Integer co2018Id) {
		this.co2018Id = co2018Id;
	}
	...
	public String toString() {
		return "Co2018 [co2018Id=" + co2018Id + ", numero=" + numero
